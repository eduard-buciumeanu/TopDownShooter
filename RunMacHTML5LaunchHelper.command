...
EPIC_MONO=""
if [ -f "E:\Unreal Engine\UnrealEngine-release\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "E:\Unreal Engine\UnrealEngine-release\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'E:\Unreal Engine\UnrealEngine-release\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
